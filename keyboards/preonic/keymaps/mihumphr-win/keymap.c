 ...
 */
    [_LOWER] = LAYOUT_preonic_grid(
        ...
        _______, KC_F11 , KC_F12 , _______, _______, _______, _______, S(KC_MINS), S(KC_EQL), S(KC_LBRC), S(KC_RBRC), KC_DEL,
 ...
 */
    [_RAISE] = LAYOUT_preonic_grid(
        ...
        _______, _______, _______, KC_UP, _______, _______, _______, S(KC_MINS), S(KC_EQL), S(KC_LBRC), S(KC_RBRC), _______,
        _______, _______, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______, KC_MINS, KC_EQL, KC_LBRC, KC_RBRC, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY),

    /* Adjust (Lower + Raise)
 * ,-----------------------------------------------------------------------------------.
 * |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |  F7  |  F8  |  F9  |  F10 |  F11 | F112 |
 * ,-----------------------------------------------------------------------------------.
 * |      | Reset|      |      |      |      |      |      |      |      |      |  Del |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |      |      |Aud on|Audoff|      |      |      |      |      |      |      |
